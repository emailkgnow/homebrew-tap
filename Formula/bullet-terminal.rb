class BulletTerminal < Formula
  ...
  # Pinned: 1.3.0 builds with uv_build, which needs Rust under Homebrew's source-only pip
  ...
  test do
    assert_match "Ask your AI", shell_output("#{bin}/bt -h")
  end
end
